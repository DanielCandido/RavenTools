  ...
  return (
    <>
      {tradepacks.map((tradepack) => (
        <div
          key={tradepack.name}
          className={`flex flex-col columns-1 justify-start p-6 gap-4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100  dark:border-gray-600 dark:hover:bg-gray-600 m-2 ${
        ...
        >
          ...
          <div className="flex lg:flex-row flex-col justify-between">
            <div className="flex items-center">
              <Icon name={tradepack.name} type="tradepacks" />
              ...
              <div className="flex flex-row flex-wrap justify-around">
                {tradepack.products.map((product, index) => (
                  ...
                  >
                    ...
                    <Icon name={product.name} type="products" />
